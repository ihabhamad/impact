@extends('admin.template.master')
        ...
        @section('breadcrumb')
                    ...
                    <li><a href="{{url('/admin/users/passwordreset/'.$userid)}}"><i class="active"></i> Password Reset</a></li>
...
@section('content')
      ...
      <div class="col-md-8">
        <div class="box box-primary">
                ...
                <!-- form start -->
                <form class="form" role="form" method="POST" action="{{ route('user.password.adminreset.submit',$userid) }}">
                  {{ csrf_field() }}
